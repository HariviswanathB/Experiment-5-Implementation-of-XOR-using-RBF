...
2.In the end_to_end function, first calculate the similarity between the inputs and thepeaks.
...
W is calculated using the same equation we use to solve linear regression using aclosed solution (normal equation).
...
5. To find the weights for the edges to the 1-output unit. Weights associated wouldbe:
...
## OUTPUT :
![Screenshot 2023-11-15 193437](https://github.com/HariviswanathB/Experiment-5-Implementation-of-XOR-using-RBF/assets/119103855/22a6f10c-52b0-4beb-b0cb-e9b67d0d7692)
![Screenshot 2023-11-15 193459](https://github.com/HariviswanathB/Experiment-5-Implementation-of-XOR-using-RBF/assets/119103855/a5f2f34b-670d-454a-a156-1eca88dbdc21)
